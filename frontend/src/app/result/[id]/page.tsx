...
export default function UserReports() {
    ...
    const fetchReport = async () => {
      try {
        ...
        const response = await fetch(
          `https://backend-services-express.victoriousdune-d492059e.southeastasia.azurecontainerapps.io/api/reports/${id}`
        );
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Navbar />
      <main className="flex-grow container mx-auto px-[12vw] md:px-[5vw] py-[20vh] font-sans">
        <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="mt-2 text-gray-600">
              {resumeAnalysis.analysis.keyword_analysis.matched_keywords_count}{" "}
          ...
          <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.length
                        )}`}
                      >
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {resumeAnalysis.analysis.length_details.word_count} words,
                      ~{resumeAnalysis.analysis.length_details.estimated_pages}{" "}
                      pages
                    </p>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.skills
                        )}`}
                      >
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.education
                        )}`}
                      >
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${resumeAnalysis.analysis.education}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.work_experience
                        )}`}
                      >
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${resumeAnalysis.analysis.work_experience}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.formatting
                        )}`}
                      >
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${resumeAnalysis.analysis.formatting}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span
                        className={`text-sm font-medium ${getScoreColor(
                          resumeAnalysis.analysis.readability
                        )}`}
                      >
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${resumeAnalysis.analysis.readability}%`,
                        }}
                      ></div>
                    </div>
                    <p className="text-xs text-gray-500 mt-1">
                      Flesch-Kincaid Grade Level:{" "}
                      {resumeAnalysis.analysis.readability_details.flesch_kincaid_grade.toFixed(
                        1
                      )}
                    </p>
                  </div>
            ...
            <div className="mt-8">
              ...
              <ul className="list-disc pl-5 space-y-2">
                {resumeAnalysis.analysis.recommendations.map(
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-2">
                {resumeAnalysis.analysis.skills_details.extracted_skills.map(
                  (skill, index) => (
                    <span
                      key={index}
                    ...
                    <div className="flex-grow">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {job.jobListing.companyName} -{" "}
                            {job.jobListing.employmentType}
                          </p>
                        ...
                        <div className="mt-2 sm:mt-0 sm:ml-4 flex sm:flex-col sm:items-end">
                          <div className="bg-blue-100 text-blue-800 font-medium rounded-full px-3 py-1 text-xs sm:text-sm">
                            {calculateMatchPercentage(job.similarity_score)}%
                            Match
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 flex justify-end">
                        <a
                          ...
                          className="inline-flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        >
                          View Job
                          <svg
